...
- `/setup`: validate the bundle, create or update the target repo managed `AGENTS.md` block, and record graph metadata.
...
- Missing, stale, or unknown graph freshness requires explicit degraded-mode approval before normal planning.
